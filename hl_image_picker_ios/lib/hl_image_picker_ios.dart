...
class HLImagePickerIOS extends HLImagePickerPlatform {
  @visibleForTesting
  final methodChannel = const MethodChannel('hl_image_picker');

  static void registerWith() {
    HLImagePickerPlatform.instance = HLImagePickerIOS();
  }
  ...
  Future<List<HLPickerItem>> openPicker({
    ...
    final data = await methodChannel.invokeMethod('openPicker', {
      ...
      'maxDuration': pickerOptions?.maxDuration ?? pickerOptions?.recordVideoMaxSecond,
